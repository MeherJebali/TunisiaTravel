<%@ Page Title="" Language="C#" MasterPageFile="~/Promotions.Master" AutoEventWireup="true" CodeBehind="Promotions.aspx.cs" Inherits="Tunisia_Travel.WebForm9" %>
...
<asp:Content ID="promos" ContentPlaceHolderID="promos" runat="server">
<center>
    <asp:SqlDataSource ID="LesPromos" runat="server" 
        ConnectionString="<%$ ConnectionStrings:CnxOffres %>" 
        
        SelectCommand="SELECT [titreOffre], [photo], [idOffre], [prix] FROM [Offres] WHERE ([promo] = @promo)">
        <SelectParameters>
            <asp:Parameter DefaultValue="True" Name="promo" Type="Boolean" />
        </SelectParameters>
    </asp:SqlDataSource>
        <asp:DataList ID="DataList1" runat="server" DataSourceID="LesPromos" 
        ...
        <table border="2" bordercolor="#14327b" rules=none  width="243" height="90">
                ...
                <tr><td align="right"><a href="DetailPromotion.aspx?idOffre=<%# Eval("idOffre") %>#dtlsO">Détails</a></td></tr>
            </tr> 
        </table>
        </ItemTemplate>
    </asp:DataList>
