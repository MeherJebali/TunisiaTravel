<%@ Page Title="" Language="C#" MasterPageFile="~/Voyages.Master" AutoEventWireup="true" CodeBehind="Voyages.aspx.cs" Inherits="Tunisia_Travel.WebForm8" %>
...
<asp:Content ID="vygs" ContentPlaceHolderID="vygs" runat="server">
<center>
    <asp:SqlDataSource ID="LesVoyages" runat="server" 
        ConnectionString="<%$ ConnectionStrings:CnxOffres %>" 
        
        SelectCommand="SELECT [idOffre], [titreOffre], [prix], [photo] FROM [Offres] WHERE ([typeOffre] = @typeOffre)">
        <SelectParameters>
            <asp:Parameter DefaultValue="True" Name="typeOffre" Type="Boolean" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:DataList ID="DataList1" runat="server" DataSourceID="LesVoyages" 
