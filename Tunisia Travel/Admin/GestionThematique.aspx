<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="GestionThematique.aspx.cs" Inherits="Tunisia_Travel.Admin.WebForm5" %>
...
<asp:Content ID="tdbord" ContentPlaceHolderID="tdbord" runat="server">
    ...
    <asp:SqlDataSource ID="SQlCategories" runat="server" 
        ...
        DeleteCommand="DELETE FROM [Categories] WHERE [idCategories] = @idCategories" 
        InsertCommand="INSERT INTO [Categories] ([LibelleCat]) VALUES (@LibelleCat)" 
        SelectCommand="SELECT [idCategories], [LibelleCat] FROM [Categories]" 
        UpdateCommand="UPDATE [Categories] SET [LibelleCat] = @LibelleCat WHERE [idCategories] = @idCategories">
        <DeleteParameters>
            <asp:Parameter Name="idCategories" Type="Int32" />
        </DeleteParameters>
        <UpdateParameters>
            <asp:Parameter Name="LibelleCat" Type="String" />
            <asp:Parameter Name="idCategories" Type="Int32" />
        </UpdateParameters>
    </asp:SqlDataSource>
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AutoGenerateColumns="False" DataKeyNames="idCategories" 
        DataSourceID="SQlCategories" BackColor="White" BorderColor="#999999" 
        BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
        <RowStyle BackColor="#EEEEEE" ForeColor="Black" />
        <Columns>
            <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" 
                HeaderText="Action" />
            <asp:BoundField DataField="LibelleCat" HeaderText="Thématiques" 
                SortExpression="LibelleCat" />
        </Columns>
