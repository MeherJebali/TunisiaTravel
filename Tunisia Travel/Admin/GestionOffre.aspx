<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="GestionOffre.aspx.cs" Inherits="Tunisia_Travel.Admin.WebForm3" %>
...
<asp:Content ID="tdbord" ContentPlaceHolderID="tdbord" runat="server">
    <center>
    <asp:SqlDataSource ID="GestionOffre" runat="server" 
        ConnectionString="<%$ ConnectionStrings:CnxOffres %>" 
        DeleteCommand="DELETE FROM [Offres] WHERE [idOffre] = @idOffre" 
        InsertCommand="INSERT INTO [Offres] ([titreOffre], [Date], [nbrJours], [prix], [description]) VALUES (@titreOffre, @Date, @nbrJours, @prix, @description)" 
        SelectCommand="SELECT [idOffre], [titreOffre], [Date], [nbrJours], [prix], [description] FROM [Offres]" 
        UpdateCommand="UPDATE [Offres] SET [titreOffre] = @titreOffre, [Date] = @Date, [nbrJours] = @nbrJours, [prix] = @prix, [description] = @description WHERE [idOffre] = @idOffre">
        <DeleteParameters>
            <asp:Parameter Name="idOffre" Type="Int32" />
        </DeleteParameters>
        <UpdateParameters>
            <asp:Parameter Name="titreOffre" Type="String" />
            <asp:Parameter Name="Date" Type="DateTime" />
            <asp:Parameter Name="nbrJours" Type="Int32" />
            <asp:Parameter Name="prix" Type="Double" />
            <asp:Parameter Name="description" Type="String" />
            <asp:Parameter Name="idOffre" Type="Int32" />
        </UpdateParameters>
    </asp:SqlDataSource>
    <asp:GridView ID="GVOffres" runat="server" AllowPaging="True" 
        AutoGenerateColumns="False" DataKeyNames="idOffre" 
        DataSourceID="GestionOffre" HorizontalAlign=Center BackColor="White" 
        BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
        GridLines="Vertical" PageSize=9>
        <RowStyle HorizontalAlign=Center BackColor="#EEEEEE" ForeColor="Black" />
        <Columns>
            <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" />
            <asp:BoundField DataField="titreOffre" HeaderText="Offre" 
                SortExpression="titreOffre" />
            <asp:BoundField DataField="Date" HeaderText="Date" SortExpression="Date" dataformatstring="{0: dd/MM/yyyy}"/>
            <asp:BoundField DataField="nbrJours" HeaderText="Nombre de jour" 
                SortExpression="nbrJours" />
