<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AjouterThematique.aspx.cs" Inherits="Tunisia_Travel.Admin.WebForm4" %>
...
<table>
<tr>
<td><label><b>Nom de la Thematique</b></label></td>
<td>
    <asp:TextBox ID="txtLibelle" runat="server"></asp:TextBox></td><asp:RequiredFieldValidator
        ID="RequiredFieldValidator1" runat="server" 
        ErrorMessage="Veuillez Saisir le nom de la Thématique" 
        ControlToValidate="txtLibelle"></asp:RequiredFieldValidator></td>
</tr>
<tr><td colspan="2" align=center>
    <asp:Button ID="btnAjouter" runat="server" Text="Ajouter" Font-Size="Large" 
        ...
        onclick="btnAjouter_Click" /></td></tr>
</table>
</center>
</asp:Content>
