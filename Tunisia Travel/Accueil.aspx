<%@ Page Title="" Language="C#" MasterPageFile="~/Accueil.Master" AutoEventWireup="true" CodeBehind="Accueil.aspx.cs" Inherits="Tunisia_Travel.WebForm1" %>
...
<asp:Content ID="offres" ContentPlaceHolderID="offres" runat="server">
    <center> Trier Par : <asp:RadioButtonList ID="Tri" runat="server" AutoPostBack="True" 
        onselectedindexchanged="Tri_SelectedIndexChanged" RepeatDirection=Horizontal>
        <asp:ListItem Selected=True Value="Prix"></asp:ListItem><asp:ListItem Value="Date"></asp:ListItem>
    </asp:RadioButtonList>
    </center>
    <asp:SqlDataSource ID="LesOffres" runat="server" 
        ConnectionString="<%$ ConnectionStrings:CnxOffres %>" 
        ></asp:SqlDataSource>
    <asp:DataList ID="DataList1" runat="server" DataSourceID="LesOffres" 
        RepeatColumns="3" HorizontalAlign="Center" BorderColor="#14327B">
        <ItemTemplate> 
        <table border="2" bordercolor="#14327b" rules=none  width="243" height="90">
                ...
                <tr><td><asp:Label ID="Label1" runat="server" Text='<%# Eval("prix") %>'></asp:Label> dt</td></tr>
...
<asp:Content ID="topOffre" ContentPlaceHolderID="topOffre" runat="server">
    <asp:SqlDataSource ID="SqlLesPlusVues" runat="server" 
        ConnectionString="<%$ ConnectionStrings:CnxOffres %>" 
        
        
        SelectCommand="SELECT TOP 8 [idOffre], [photo], [prix], [nbVisite], [titreOffre] FROM [Offres] ORDER BY [nbVisite] DESC"></asp:SqlDataSource>
        <center>
    <asp:DataList ID="DataList2" runat="server" DataKeyField="idOffre" 
        DataSourceID="SqlLesPlusVues">
        <ItemTemplate>
           <table border="2" bordercolor="#f3961b" rules=none  width="300px" height="90">
            <tr>
              <td rowspan="3">
                <asp:Image ID="Image1" runat="server" ImageURL='<%# Eval("photo") %>'  Width="150px" Height="85" />
              </td>
              <td colspan="2">
                <asp:Label ID="Label3" runat="server" Text='<%# Eval("titreOffre") %>' Font-Bold="True"></asp:Label>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <asp:Label ID="Label1" runat="server" Text='<%# Eval("prix") %>'></asp:Label> dt
              </td>
            </tr>
            <tr>
              <td>
                Visitée <asp:Label ID="Label4" runat="server" Text='<%# Eval("nbVisite") %> '></asp:Label> fois
              </td>
              <td>
                <a href="Offre.aspx?idOffre=<%# Eval("idOffre") %>#dtlsO">Détails</a>
              </td>
            </tr>
