<%@ Page Title="" Language="C#" MasterPageFile="~/SejoursTn.Master" AutoEventWireup="true" CodeBehind="SejoursTn.aspx.cs" Inherits="Tunisia_Travel.WebForm7" %>
...
<asp:Content ID="sjrs" ContentPlaceHolderID="sjrs" runat="server">
<center>
    <br />
    <asp:SqlDataSource ID="LesSejours" runat="server" 
        ConnectionString="<%$ ConnectionStrings:CnxOffres %>" 
        SelectCommand="SELECT [idOffre], [titreOffre], [prix], [photo] FROM [Offres] WHERE ([typeOffre] = @typeOffre)">
        <SelectParameters>
            <asp:Parameter DefaultValue="False" Name="typeOffre" Type="Boolean" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:DataList ID="DataList1" runat="server" DataSourceID="LesSejours" 
