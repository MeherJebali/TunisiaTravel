<%@ Page Title="" Language="C#" MasterPageFile="~/Inscription.Master" AutoEventWireup="true" CodeBehind="Inscription.aspx.cs" Inherits="Tunisia_Travel.WebForm4" %>
...
<asp:Content ID="inscrit" ContentPlaceHolderID="inscrit" runat="server">
<center>
    <h3>Inscription</h3>
    <p>
        ...
        <LoggedInTemplate>
            Vous êtes connecté(e) en tant que : <asp:LoginName ID="LoginName1" runat="server" />
            <br />
