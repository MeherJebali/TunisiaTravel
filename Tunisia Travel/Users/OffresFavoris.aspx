<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Profil.Master" AutoEventWireup="true" CodeBehind="OffresFavoris.aspx.cs" Inherits="Tunisia_Travel.Users.WebForm2" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="offresprefere" runat="server">
    <center>
    <asp:SqlDataSource ID="MesPreferes" runat="server" 
        ConnectionString="<%$ ConnectionStrings:CnxOffres %>"></asp:SqlDataSource>
        <br />
        <h2>Vos Offres Préférées</h2>
    <asp:DataList ID="DataList1" runat="server" DataSourceID="MesPreferes" 
        ...
        <table border="2" bordercolor="#14327b" rules=none  width="243" height="90">
            ...
            <tr><td colspan="2" align="center"><a href="supprimer.aspx?idOffre=<%# Eval("idOffre") %>">Supprimer</a>
               </td></tr>
        </table>
        </ItemTemplate>
    </asp:DataList>    
