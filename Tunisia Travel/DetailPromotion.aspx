<%@ Page Title="" Language="C#" MasterPageFile="~/DetailPromotion.Master" AutoEventWireup="true" CodeBehind="DetailPromotion.aspx.cs" Inherits="Tunisia_Travel.WebForm10" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="dtlprm" runat="server">
<center>
    <h2><asp:Label ID="lblVide" runat="server" Text=""></asp:Label></h2></center>
    <asp:SqlDataSource ID="DetailPrms" runat="server" 
        ConnectionString="<%$ ConnectionStrings:CnxOffres %>" 
        
        SelectCommand="SELECT Offres.titreOffre, TypePromotions.detailType, Promotions.Details, Offres.Date, Offres.nbrJours, Offres.photo, Offres.prix FROM Offres , Promotions ,TypePromotions WHERE (Offres.idOffre = @idOffre) AND Offres.idOffre = Promotions.offre AND Promotions.typeProm = TypePromotions.idType">
        <SelectParameters>
            <asp:QueryStringParameter Name="idOffre" QueryStringField="idOffre" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:DataList ID="DataList1" runat="server" DataSourceID="DetailPrms" 
            Width="80">
            <ItemTemplate>
                <font color="#14327c"><h1><asp:Label ID="titreOffreLabel" runat="server" 
                    Text='<%# Eval("titreOffre") %>' /></h1></font>
                <br />
                <font color="#f3961b"><b>Type de la promotion</b></font>
                <asp:Label ID="lblTypePrm" runat="server" Text='<%# Eval("detailType") %>'></asp:Label>
                <br />
                <br />
                <font color="#f3961b"><b>Description de la promotion:</b></font>
